  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
          ...
          <ol id="wd-pancakes">
          <li>In a bowl, whisk together 1 cup of flour, 2 tablespoons of sugar, 1 teaspoon of baking powder, and a pinch of salt.</li>
          <li>In a separate bowl, whisk 1 egg with 1 cup of milk and 2 tablespoons of melted butter.</li>
          <li>Pour the wet ingredients into the dry ingredients and stir until just combined, leaving some lumps in the batter.</li>
          <li>Heat a non-stick pan over medium heat and lightly grease it with butter or oil.</li>
          <li>Pour about 1/4 cup of batter onto the pan for each pancake and cook until bubbles form on the surface.</li>
          <li>Flip the pancakes and cook for another 1-2 minutes until golden brown.</li>
          <li>Serve warm with syrup, fresh fruit, or your favorite toppings and enjoy!</li>
          </ol>
          My favorite recipe:Boba Milk Tea
          <ol id="wd-your-favorite-recipe">
          <li>Boil 1 cup of water in a pot.</li>
          <li>Add 1/4 cup of boba pearls and cook for 5-10 minutes, stirring occasionally.</li>
          <li>Once the pearls are soft, drain and rinse with cold water.</li>
          <li>Prepare tea (black or green) by steeping a tea bag in hot water for 3-5 minutes.</li>
          <li>In a cup, add 2 tablespoons of sugar syrup and the cooked boba pearls.</li>
          <li>Pour the brewed tea over the pearls, then add 1/2 cup of milk or a milk alternative.</li>
          <li>Stir well, add ice if desired, and enjoy your homemade boba milk tea!</li>
          </ol>
      ...
      <div id="wd-images">
          ...
          <img id="wd-starship"
              ...
              alt="Starship from Star Advertiser" />
          <br />
      ...
      <div id="wd-forms">
          ...
          <form id="wd-text-fields">
              ...
              <h5>Buttons</h5>
              <button id="wd-all-good" onClick={() => alert("Hello!")} type="button">
                  Hello World!
              </button>
              ...
              Please
              <a id="wd-github" href="https://github.com/RicChen0001/Kanbas-react-web-app">click here</a>
              to my GitHub code repository<br />
