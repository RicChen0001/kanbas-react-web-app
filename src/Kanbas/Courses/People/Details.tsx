...
import { useEffect, useState } from "react";
import { FaUserCircle, FaPencilAlt, FaCheck } from "react-icons/fa"; // Correct icon import
import { IoCloseSharp } from "react-icons/io5";
import { useParams, useNavigate } from "react-router";
import * as client from "../../Account/client";
...
export default function PeopleDetails() {
  ...
  const saveUser = async () => {
    ...
    await client.updateUser(updatedUser); // Corrected to pass a single argument
    setUser(updatedUser);
    setEditing(false);
    navigate(-1);
  };
  ...
  return (
    <div className="wd-people-details position-fixed top-0 end-0 bottom-0 bg-white p-4 shadow w-25">
      ...
      <div className="text-danger fs-4">
        {!editing && (
          <FaPencilAlt
            onClick={() => setEditing(true)} // Corrected to use FaPencilAlt
