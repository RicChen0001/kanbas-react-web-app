      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-total-activity">8:16:45</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-total-activity">12:45:30</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2021-02-18</td>
            <td className="wd-total-activity">9:32:12</td>
          </tr>
        </tbody>
      </table>
    </div>
